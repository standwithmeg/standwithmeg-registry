...
from generate_state_pdf import build_states, normalize_report_location, state_stats  # noqa: E402
...
def _to_headline(state_abbr: str, rows: list) -> dict:
    ...
    return {
        ...
        "pro_se_count": int(d.get("pro_se_count") or 0),
        "source": "scripts/pdf/state_stats_for_share.py",
    }
...
def stats_for_state(state_abbr: str) -> dict:
    ...
    state_abbr = normalize_report_location(state_abbr)
