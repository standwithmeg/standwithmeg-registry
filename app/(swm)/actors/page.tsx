...
export default function ActorsPage() {
  ...
  return (
    <main suppressHydrationWarning>
      ...
      <nav className="flex flex-wrap justify-center gap-x-4 gap-y-2 px-6 py-5 text-xs font-semibold text-white/70" style={{ backgroundColor: "#0F1E30" }}>
        <Link href="/report" className="hover:text-white">Report</Link>
        <Link href="/survey" className="hover:text-white">Survey</Link>
        <Link href="/court-actor-update" className="hover:text-white">Update Actor Info</Link>
        <Link href="/connect" className="hover:text-white">Connection Circles</Link>
