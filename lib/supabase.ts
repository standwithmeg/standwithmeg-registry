...
// Browser client — safe to use in client components and API routes that don't need elevated privileges
...
// Server client — uses the anon key with the request's cookie session.
